...
function changebb(){
  ...
  document.getElementById("bb").style.transform= "rotateY(0deg)";
}
...
function changedd(){
  ...
  document.getElementById("dd").style.transform= "rotateY(0deg)";
}
...
function changeff(){
  ...
  document.getElementById("ff").style.transform= "rotateY(0deg)";
}
...
function changehh(){
  ...
  document.getElementById("hh").style.transform= "rotateY(0deg)";
}